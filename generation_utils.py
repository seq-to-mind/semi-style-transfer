...
class GenerationMixin:
    ...
    """ [updated for return logits after generation] """
    # @torch.no_grad()
    def generate(
        self,
        ...
        **model_kwargs,
        ...
        while cur_len < max_length:
            ...
            if return_dict_in_generate:
                if output_scores:
                    scores += (next_token_logits.unsqueeze(1),)
        ...
        while cur_len < max_length:
            ...
            if return_dict_in_generate:
                if output_scores:
                    ...
                    """ edit by [updated for return logits after generation]: return the next_token_logits for RL training """
                    scores += (next_token_logits.unsqueeze(1),)
            ...
            # sample
            """ [updated for return logits after generation] : add 0.5 temperature for softmax"""
            probs = F.softmax(next_token_scores / 0.8, dim=-1)
